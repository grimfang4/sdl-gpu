...
int main(int argc, char* argv[])
{
    ...
    SDL_Surface* surface = SDL_CreateRGBSurface(SDL_SWSURFACE, 400, 400, 32,
                                   rmask, gmask, bmask, amask);
	if(surface == NULL)
        return -2;
	
	Uint32 red_pixel = SDL_MapRGBA(surface->format, 255, 0, 0, 255);
	Uint32 white_pixel = SDL_MapRGBA(surface->format, 255, 255, 255, 255);
